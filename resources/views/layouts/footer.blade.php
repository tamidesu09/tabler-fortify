...
<div class="my-5">
  <!-- Footer -->
  <footer
          class="text-center text-lg-start text-white" style="background-color: #163673"
          >
    <!-- Grid container -->
      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p><i class="fas fa-home mr-3"></i> bgutay@ibts.com.ph</p>
            <p><i class="fas fa-envelope mr-3"></i> support@ibts.com.ph</p>
            <p><i class="fas fa-phone mr-3"></i> (+63) 917 824 8878 </p>
          </div>
          <!-- Grid column -->
        </div>
        <!--Grid row-->
